local MoneyLeadboard = {}

local DataStoreService = game:GetService("DataStoreService")
local store = DataStoreService:GetOrderedDataStore("MoneyLeadboard_1.0")

function MoneyLeadboard:Init() end
...
function MoneyLeadboard:GetLeaderboards()
	local leaderboards = {}
	local success, _ = pcall(function()
